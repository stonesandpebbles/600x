...
class TitleTrigger(WordTrigger):
    def evaluate(self, text):
        return self.isWord(text.getTitle())
    
# TODO: SubjectTrigger
class SubjectTrigger(WordTrigger):
    def evaluate(self, text):
        
        return self.isWord(text.getSubject())
# TODO: SummaryTrigger
class SummaryTrigger(WordTrigger):
    def evaluate(self, text):
        
        return self.isWord(text.getSummary())
...
class PhraseTrigger(Trigger):
    def __init__(self, phrase):
        self.phrase = phrase
    def evaluate(self, text):
        return (self.phrase in text.getTitle()) or (self.phrase in text.getSummary()) or (self.phrase in text.getSubject())
